...
public class Homework4 {
    ...
    public static void main(String[] args) {
        ...
        // WebElement name1 = driver.findElement(By.className("search-box-text ui-autocomplete-input"));
        WebElement name2 = driver.findElement(By.id("small-searchterms"));
        WebElement name3 = driver.findElement(By.cssSelector("#small-searchterms"));
        WebElement name4 = driver.findElement(By.xpath("//*[@id=\"small-searchterms\"]"));
        WebElement name5 = driver.findElement(By.linkText("Tricentis"));
